...
namespace WebApi.OutputCache.V2
{
    ...
    public class CacheOutputConfiguration
    {
        ...
        public IApiOutputCache GetCacheOutputProvider(HttpRequestMessage request)
        {
            ...
            var cacheOutputProvider = ServiceLocator.Current.GetInstance<IApiOutputCache>();
            //var cacheFunc = cache as Func<IApiOutputCache>;

            // // request.GetConfiguration().Services.GetService()
            //var cacheOutputProvider = cacheFunc != null ? cacheFunc() : request.GetConfiguration().Services.GetService(typeof(IApiOutputCache)) as IApiOutputCache ?? new MemoryCacheDefault();
